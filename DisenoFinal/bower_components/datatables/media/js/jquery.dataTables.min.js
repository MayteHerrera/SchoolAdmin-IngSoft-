...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No data available in table",sInfo:"Mostrando del _START_ al _END_ de _TOTAL_ Entradas",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtrado de _MAX_ entradas en total)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Ver _MENU_ Entradas",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(m.defaults);m.defaults.column={aDataSort:null,iDataSort:-1,
